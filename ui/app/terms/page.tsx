    ...
    <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column", background: "#000000" }}>
      ...
      <main style={{ flex: 1, maxWidth: 800, width: "100%", margin: "0 auto", padding: "60px 20px 80px" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 32, fontSize: 14, color: "#a1a1aa", lineHeight: 1.7 }}>
          ...
          <section>
            <h2 style={{ fontSize: 18, fontWeight: 700, color: "#ffffff", marginBottom: 12 }}>2. API Fair Usage & Rate Limits</h2>
            <p>
          ...
          <section>
            <h2 style={{ fontSize: 18, fontWeight: 700, color: "#ffffff", marginBottom: 12 }}>3. Subscriptions & Billing</h2>
            <p>
          ...
          <section>
            <h2 style={{ fontSize: 18, fontWeight: 700, color: "#ffffff", marginBottom: 12 }}>4. SLA & Uptime Disclaimer</h2>
            <p>
